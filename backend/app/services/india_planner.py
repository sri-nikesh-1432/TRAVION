...
def build_estimate_plan(
    ...
    # (guide 12.5% + platform 3%) — the spend itself is the traveller's budget,
    # so only the ADVENTUROUS case backs the 3% platform fee out of the
    # ceiling. The fee-inclusive total is what build_plans reports as payable.
